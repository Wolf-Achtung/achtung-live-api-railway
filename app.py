...
app = Flask(__name__)
CORS(app)  # Erlaubt CORS für lokale Tests

# Root-Route für Sichtbarkeitscheck
@app.route('/', methods=['GET'])
def index():
    return 'achtung.live API läuft – bereit für POST /analyze'
...
# Analyse-Logik inkl. URL-Prüfung
def analyze(text):
...
# Alle URLs im Text extrahieren und prüfen
